        ...
        return array(
            ...
            array(
                ...
                'fields' => array(
                    ...
                    self::field( 'disability_reason', 'Яка причина інвалідності чи реєстрації Вас, як особи з особливими освітніми потребами повʼязаними з фізичним чи психічним здоровʼям?', 'checkbox', false, array( 'vision_impairment' => 'Порушення зору', 'hearing_impairment' => 'Порушення слуху', 'musculoskeletal_impairment' => 'Порушення опорно-рухового апарата', 'physical_development_impairment' => 'Порушення фізичного розвитку', 'serious_medical_condition' => 'Важке медичне захворювання', 'mental_health_impairment' => 'Порушення у сфері психічного здоровʼя', 'Інше' => 'Інше' ), self::in( 'health_status', ['disability','physical_health_difficulties','mental_health_difficulties'] ) ),
                    self::field( 'health_condition_details', 'Уточніть щодо наявного у Вас порушення стану здоровʼя', 'checkbox', false, array( 'blindness' => 'тотальна сліпота', 'partial_vision_loss' => 'часткова втрата зору', 'deafness' => 'глухота', 'hard_of_hearing' => 'туговухість', 'uses_crutches' => 'пересуваюся на милицях', 'uses_wheelchair' => 'пересуваюся на візку', 'depressive_or_anxiety_states' => 'депресивні та/або тривожні стани', 'personality_disorders' => 'особистісні розлади', 'eating_disorders' => 'харчові розлади', 'other' => 'інше', 'Інше' => 'Інше' ), self::in( 'health_status', ['disability','physical_health_difficulties','mental_health_difficulties'] ) ),
